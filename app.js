...
const passport = require('./passport'); //no pongo el archivo index para que busque la carpeta y no el archivo
...
// Middleware Setup MIDDLEWARE GENERAL
...
app.locals.title = 'Passport with Joss';
...
app.use(require('./routes/authRoutes'))  //registrar authRoutes
